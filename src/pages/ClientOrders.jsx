                    ...
                    <div className="flex flex-wrap items-start justify-between gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="mt-2.5 flex flex-wrap gap-x-4 gap-y-1.5 text-sm text-neutral-400">
                          <span>
                            👤 <span className="text-neutral-300">{order.botUser?.fullName || "Неизвестно"}</span>
                          </span>
                          <span>
                            📞 <span className="text-neutral-300">{formatPhone(order.botUser?.phone)}</span>
                          </span>
                          {total > 0 && (
                            <span>
                              💵 <span className="text-orange-400 font-medium">{total.toLocaleString("ru-RU")} сум</span>
                            </span>
                          )}
                        </div>
                        ...
                        <div className="mt-3">
                          {link ? (
                            ...
                            <span className="text-sm text-neutral-600">📍 Локация ещё не получена</span>
                          )}
                        </div>
                      </div>
